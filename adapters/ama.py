...
Native surface: HTTP `POST /trading_action/` (see AmaHttpShim + runners/ama_http.py).
...
class AmaEnvAdapter:
    ...
    def describe(self) -> Mapping[str, Any]:
        return {
            ...
            "entry": "runners/ama_http.py → POST /trading_action/",
    ...
    def _run_full(self, agent: AgentAdapter, proto: ProtocolSpec) -> SuiteResult:
        from runners.ama_http import AmaHttpServer
        from runners.yahoo import fetch_daily_bars, is_crypto, price_on_or_before
