...
Phase E: McpPlugin is the first registered plugin. Yahoo stays runners/yahoo.py.
"""
...
from sandbox.plugins.base import EnvPlugin
...
class PluginFactory:
    _MAP: dict[str, str] = {
        "mcp": "sandbox.plugins.mcp:McpPlugin",
    }
